...
public interface CosmeticService {
     ...
     * @param product
     * @return 삽입 성공하면 true, 실패 시 false 반환
     */
    public boolean insert(Product product);

    /**
     * 전달받은 Product 객체(립스틱, 파운데이션) 데이터를 객체배열내에서 찾은 후 값을 수정 

...
public class FemaleMember extends Fitness {

    // 생성자
    public FemaleMember(String id, String name, double height, double weight, String trainerName) {
        super(id, name, height, weight, trainerName);
    }

    /**
     * 추상 메소드 구현: 여성의 표준 체중 계산
     * 표준체중 = 키(m) * 키(m) * 21
     */
    @Override
    public void calcStdWeight() {
        double heightInMeters = getHeight() / 100.0;
        super.stdWeight = heightInMeters * heightInMeters * 21;
    }
